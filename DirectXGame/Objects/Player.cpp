...
void Player::Initialize() {
	...
	// configs->AddItem(groupName, "directLeft", directLeft_);
	configs->AddItem(groupName, "kDrawTimeLine", kDrawTimeLine_);
	// configs->AddItem(groupName, "drawTimeLine", drawTimeLine_);
...
void Player::AddlyGlobalConfigs() {
	...
	// directLeft_ = configs->GetFloatValue(groupName, "directLeft");
	kDrawTimeLine_ = configs->GetIntValue(groupName, "kDrawTimeLine");
	// drawTimeLine_ = configs->GetIntValue(groupName, "drawTimeLine");
}
